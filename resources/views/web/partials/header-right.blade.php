<div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
    <div class="dropdown zindex-popover">
        <a class="nav-link dropdown-toggle pulse" href="#" role="button" data-bs-toggle="dropdown">
            <img src="{{ asset('assets/images/flag/GB.png') }}" width="24px" height="24px" alt="">
        </a>
                ...
                <ul class="list-unstyled py-2 px-3 mb-0">
                    <li class="mb-2">
                        <a href="#" class="d-flex" style="gap: 8px">
                            <img src="{{ asset('assets/images/flag/VN.png') }}" width="24px" height="24px" alt="">
                            Tiếng Việt
                        </a>
                    </li>
                    <li class="mb-2">
                    ...
                    <li class="mb-2">
                        <a href="#" class="d-flex" style="gap: 8px">
                            <img src="{{ asset('assets/images/flag/CN.png') }}" width="24px" height="24px" alt="">
                            中文
                        </a>
                    </li>
                </ul>
                ...
                <div class="card-body pb-0">
                    <div class="d-flex py-1">
                        <img class="avatar rounded-circle"
                             src="{{asset('assets/images/avatar.png')}}" alt="profile">
