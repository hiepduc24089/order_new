                            ...
                            <div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-md-end p-0 m-0 mt-3">
                                <div class="card border-0">
                                    <ul class="list-unstyled py-2 px-3 mb-0">
                                        ...
                                        <li class="mb-2">
                                            <a href="#" class="d-flex" style="gap: 8px">
                                                <img src="assets/images/flag/KR.png" width="24px" height="24px" alt="">
                                                한국어
                                            </a>
                                        </li>
                                    </ul>
                        ...
                        <div class="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center zindex-popover">
                            <div class="u-info me-2">
                                <p class="mb-0 text-end line-height-sm "><span
                                        class="font-weight-bold">John Quinn</span></p>
                                <small>Admin Profile</small>
                            </div>
                            <a class="nav-link dropdown-toggle pulse p-0" href="#" role="button"
                               data-bs-toggle="dropdown" data-bs-display="static">
                                <img class="avatar lg rounded-circle img-thumbnail"
                                     src="../../public/assets/images/profile_av.svg" alt="profile">
                            </a>
                            <div
                        ...
                        <div class="tab-filter d-flex align-items-center justify-content-between mb-3 flex-wrap">
                            ...
                            <div class="date-filter d-flex align-items-center mt-2 mt-sm-0 w-sm-100">
                                <div class="input-group">
                                    ...
                                    <button class="btn btn-primary" type="button"><i class="icofont-filter fs-5"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <table id="myDataTable" class="table table-hover align-middle mb-0"
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="../../public/assets/images/product/product-1.jpg"
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="../../public/assets/images/product/product-2.jpg"
                                                 class="avatar lg rounded me-2"
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="../../public/assets/images/product/product-3.jpg"
                                                 class="avatar lg rounded me-2"
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="../../public/assets/images/product/product-4.jpg"
                                                 class="avatar lg rounded me-2"
